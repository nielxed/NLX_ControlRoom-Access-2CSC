...
def app_Header_Brand():
        return nlxFT.Container(
            content=nlxFT.Row(
                ...
                nlxFT.Text("Celeborn 0.1.3", size=15, color="white")
                ]
            )
        )
...
This version will alter the way that the asset is called because of a missmatch between c2960 and ie3010 machines.

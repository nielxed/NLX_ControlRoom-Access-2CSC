...
assetLst.append(assetBtn)
assetBtn = assetButtonCls("GHQ.MEZ.46", "HQ Server Room", "BUSINESS_ROUNDED", "192.168.77.11", "Gi3/0/45", "rbt_CSC_113045")
assetLst.append(assetBtn)
# --------------------
...
assetLst.append(assetBtn)
assetBtn = assetButtonCls("OHQ17", "Old HQ Server Room", "HOME_WORK_ROUNDED", "192.168.77.13", "Gi1/0/1", "rbt_CSC_13102")
assetLst.append(assetBtn)
assetBtn = assetButtonCls("OHQ7", "Old HQ Server Room", "HOME_WORK_ROUNDED", "192.168.77.13", "Gi1/0/1", "rbt_CSC_13103")
assetLst.append(assetBtn)
assetBtn = assetButtonCls("OHQ3", "Old HQ Server Room", "HOME_WORK_ROUNDED", "192.168.77.13", "Gi1/0/1", "rbt_CSC_13104")
assetLst.append(assetBtn)
assetBtn = assetButtonCls("OHQ5", "Old HQ Server Room", "HOME_WORK_ROUNDED", "192.168.77.13", "Gi1/0/1", "rbt_CSC_13105")
assetLst.append(assetBtn)
assetBtn = assetButtonCls("OHQ19", "Old HQ Server Room", "HOME_WORK_ROUNDED", "192.168.77.13", "Gi1/0/1", "rbt_CSC_13106")
assetLst.append(assetBtn)

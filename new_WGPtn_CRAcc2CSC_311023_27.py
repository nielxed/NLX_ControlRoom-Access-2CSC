...
def main(page: nlxFT.Page):
    ...
    def open_nskBar_version(e):
        page.snack_bar = nlxFT.SnackBar(nlxFT.Text(f"Version: Rls. 0.2.7"))
...
None
New Assets:
User welcome note or user bar coloring changed to white.
Testing updated modal as refferenced in new_WGtn_CRAcc2CSC_311023_Modal_1.py
Result: Seems correct (at 151022112023). Testing not completed.
References:

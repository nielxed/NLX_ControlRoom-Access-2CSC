...
userComment = nlxFT.Text(value="", style=nlxFT.TextThemeStyle.TITLE_MEDIUM, weight=nlxFT.FontWeight.BOLD, color="white")
...
def main(page: nlxFT.Page):
    ...
    def open_nskBar_version(e):
        page.snack_bar = nlxFT.SnackBar(nlxFT.Text(f"Version: Rls. 0.3.8"))
                ...
                controls=[
                    ...
                    nlxFT.Container(
                        ...
                        content=nlxFT.Row(
                            ...
                            # self-control instances added here:
                            controls=[
                                nlxFT.ElevatedButton(text="Actions list record", icon=nlxFT.icons.PENDING_ACTIONS_ROUNDED, 
                                bgcolor=nlxFT.colors.BLUE_GREY_100, color=nlxFT.colors.BLACK, expand=1, on_click=rbt_CSC_101024,
                                style=nlxFT.ButtonStyle(shape=nlxFT.RoundedRectangleBorder(radius=4)),
                                )
                            ]
                        )
                    ),
                    ...
                    nlxFT.Container(
                        ...
                        bgcolor="#081d33", border_radius=nlxFT.border_radius.only(bottom_left=10, bottom_right=10, top_left=4, top_right=4), 
                            padding=nlxFT.padding.only(left=15, right=15),
                        content=nlxFT.Row(

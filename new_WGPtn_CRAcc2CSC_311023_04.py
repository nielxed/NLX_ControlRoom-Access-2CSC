...
def main(page: nlxFT.Page):
    ...
    def app_Header_Brand():
        return nlxFT.Container(
            content=nlxFT.Row(
                ...
                nlxFT.Text("Celeborn 0.0.4", size=15, color="white")
                ],
            ),
        )
    ...
    def app_Header_Avatar():
        return nlxFT.Container(
            content=nlxFT.IconButton(nlxFT.icons.PERSON_2_ROUNDED, on_click=open_dlg_UserLogin)
        )
...
Beta version named
Copying assets from WGPtn_CRAcc2CSC_SLClass_07062023_011.py
Assets:
app_Header_Brand
app_Header_Search (disabled)
app_Header_Avatar (modified as button to call already deviced dlg_UserLogin)
Result: Looks Good
References:

...
def app_Header_Brand():
        return nlxFT.Container(
            content=nlxFT.Row(
                controls=[
                nlxFT.Icon(name=nlxFT.icons.CAMERA_ROUNDED, color="white"),
                nlxFT.Text("Amdir 0.2.3", size=15, color="white")
                ]
            )
        )
# Global definitions END

0# Main page definition START
        ...
        nlxFT.Container(
            ...
            content=nlxFT.Column(
                controls=[
                    ...
                    nlxFT.Divider(height=1, color="Transparent"),
                    ...
                    nlxFT.Container(
                        ...
                        content=
                            nlxFT.Row(
                                expand=True, height=40, alignment=nlxFT.MainAxisAlignment.START,
                    ...
                    nlxFT.Container(
                        expand=True, height=750, bgcolor="white10", border=nlxFT.border.all(1, "#ebebeb"), border_radius=8, padding=15,
                        content=nlxFT.Column(
                            expand=True,
                            controls=[
                                nlxFT.Tabs(
...
None
New Assets:
User displays under header bar when logedin.
Result: Good
References:
